...
##Sample size=36 & Cohort size=3 & stopping rule after 12 patients
...
#number of patients to stop after, if next recommended dose already has this number assigned
stop_pat<-12
...
while(cohort<max_cohort){
  ...
  #stopping rule
  if((all(nextdose==dose_esc[cohort,]))&(current_n[nextdose[1],nextdose[2]]==stop_pat)){
    recdose<-nextdose
    break
  }
...
#store
assign(paste(c("BOIN_rec_",tSS,"s"),collapse=""),recdose)
assign(paste(c("BOIN_dose_esc_",tSS,"s"),collapse=""),dose_esc)
assign(paste(c("BOIN_dose_esc2_",tSS,"s"),collapse=""),dose_esc2)
assign(paste(c("BOIN_nmat_",tSS,"s"),collapse=""),current_n)
assign(paste(c("BOIN_ymat_",tSS,"s"),collapse=""),current_y)
...
while(cohort<max_cohort){
  ...
  #stopping rule
  if((current_n[nextdose[1],nextdose[2]]==stop_pat)){
    recdose<-nextdose
    break
  }
  dose_esc[cohort+1,]<-nextdose
...
#store
assign(paste(c("PIPE_rec_",tSS,"s"),collapse=""),recdose)
assign(paste(c("PIPE_dose_esc_",tSS,"s"),collapse=""),dose_esc)
assign(paste(c("PIPE_dose_esc2_",tSS,"s"),collapse=""),dose_esc2)
assign(paste(c("PIPE_nmat_",tSS,"s"),collapse=""),current_n)
assign(paste(c("PIPE_ymat_",tSS,"s"),collapse=""),current_y)
...
assign(paste(c("KEY_rec_",tSS,"s"),collapse=""),recdose)
assign(paste(c("KEY_dose_esc_",tSS,"s"),collapse=""),dose_esc)
assign(paste(c("KEY_dose_esc2_",tSS,"s"),collapse=""),dose_esc2)
assign(paste(c("KEY_nmat_",tSS,"s"),collapse=""),current_n)
assign(paste(c("KEY_ymat_",tSS,"s"),collapse=""),current_y)
...
assign(paste(c("SF_rec_",tSS,"s"),collapse=""),recdose)
assign(paste(c("SF_dose_esc_",tSS,"s"),collapse=""),dose_esc)
assign(paste(c("SF_dose_esc2_",tSS,"s"),collapse=""),dose_esc2)
assign(paste(c("SF_nmat_",tSS,"s"),collapse=""),current_n)
assign(paste(c("SF_ymat_",tSS,"s"),collapse=""),current_y)
################################################################################
#blrm
#model file for rjags
cat("model{
...
assign(paste(c("BLRM_rec_",tSS,"s"),collapse=""),recdose)
assign(paste(c("BLRM_dose_esc_",tSS,"s"),collapse=""),dose_esc)
assign(paste(c("BLRM_dose_esc2_",tSS,"s"),collapse=""),dose_esc2)
assign(paste(c("BLRM_nmat_",tSS,"s"),collapse=""),current_n)
assign(paste(c("BLRM_ymat_",tSS,"s"),collapse=""),current_y)
...
assign(paste(c("BLRM_rec2_",tSS,"s"),collapse=""),recdose)
assign(paste(c("BLRM_dose_esc2_",tSS,"s"),collapse=""),dose_esc)
assign(paste(c("BLRM_dose_esc22_",tSS,"s"),collapse=""),dose_esc2)
assign(paste(c("BLRM_nmat2_",tSS,"s"),collapse=""),current_n)
assign(paste(c("BLRM_ymat2_",tSS,"s"),collapse=""),current_y)
